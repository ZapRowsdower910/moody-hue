...
angular.module("btford.socket-io", []).provider("socketFactory", function() {
    ...
    this.$get = [ "$rootScope", "$timeout", function(t, e) {
        ...
        return function(e) {
            e = e || {};
            var o = e.ioSocket || io.connect(), c = void 0 === e.prefix ? n : e.prefix, u = e.scope || t, i = function(n, t) {
                o.on(n, t.__ng = r(o, t));
            }, a = function(n, t) {
                ...
                once: a,
                emit: function(n, t, e) {
                    var c = arguments.length - 1, e = arguments[c];
                    return "function" == typeof e && (e = r(o, e), arguments[c] = e), o.emit.apply(o, arguments);
                },
